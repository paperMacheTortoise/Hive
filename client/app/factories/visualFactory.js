...
.factory('Visualization', ['$firebaseArray', '$firebaseObject',function ($firebaseArray, $firebaseObject) {
  ...
  // Returns data array of account information from the DB.  This information was populated
  // in the DB by pulling from Quickbooks.
  ...
  // BubbleChart constructor that is used for inheritance by other visualization constructors.
